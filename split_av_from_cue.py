...
for i in range(0, len(tracks2)):
	...
	tm4   = a["tm4"]; len2 = None   ## milliseconds = tm4[2]
	tdBgn = datetime.timedelta( minutes = tm4[0], seconds = tm4[1] )
	bgn2  = tdBgn.total_seconds()
	if n:
		tm5 = n["tm4"]
		## milliseconds__ = tm5[2] / 75.0
		tdEnd = datetime.timedelta( minutes = tm5[0], seconds = tm5[1] )
		len2 = (tdEnd - tdBgn).total_seconds()
	tracks3.append( {"bgn": a["tm2"], "bgn2": bgn2, "len2": len2, "ath": a["ath"], "ttl": a["ttl"],} )
